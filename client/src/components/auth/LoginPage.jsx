        ...
        <Card sx={{ width: '100%' }}>
          <CardContent>
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              {(process.env.NODE_ENV === 'development' || window.location.pathname === '/login/admin') && (
                <Box sx={{ mt: 2, textAlign: 'center' }}>
                  <Link
                    component="button"
                    variant="body2"
                    onClick={() => navigate(userType === 'admin' ? '/login/registration' : '/secure-admin')}
                  >
                    {userType === 'admin' ? 'Go to Registration Office Login' : 'Administrator Access'}
                  </Link>
                </Box>
              )}
            </form>
